        ...
        <div className="lg:w-auto lg:h-screen lg:flex lg:justify-center lg:items-center lg:gap-10">
          <div className="flex flex-col justify-center gap-3 lg:w-[50%]">
            ...
            >
              ...
              positiva, perseverancia y habilidad para trabajar en equipo, estoy
              listo para aportar mi entusiasmo y talento a tu proyecto. <br />{" "}
              <br /> Juntos, llevaremos tus soluciones digitales al siguiente
              nivel...
            </motion.div>
